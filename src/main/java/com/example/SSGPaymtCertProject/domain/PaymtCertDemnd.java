...
@ToString
@Entity
@Table(name = "PAYMT_CERT_DEMND")
public class PaymtCertDemnd extends BaseEntity {
    @Id
    @GeneratedValue
    @Column(name = "PG_PAYMT_CERT_ID")
    ...
    @Column(name = "ORDPE_ID", nullable = false)
    ...
    @Column(name = "PAYMT_CERT_RST_URL", nullable = false)
